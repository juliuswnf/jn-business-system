...
export const createWidget = async (req, res) => {
  try {
    ...
    console.log(`✅ Widget created for salon: ${salonId}`);
...
export const getWidgetByApiKey = async (req, res) => {
  try {
    ...
    console.error('❌ GetWidgetByApiKey Error:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to fetch widget'
    });
...
export const updateWidget = async (req, res) => {
  try {
    ...
    console.log(`✅ Widget updated: ${widget._id}`);
...
export const regenerateApiKey = async (req, res) => {
  try {
    ...
    console.log(`⚠️ API Key regenerated for salon: ${salonId}`);
...
export const deleteWidget = async (req, res) => {
  try {
    ...
    console.log(`✅ Widget deleted: ${widget._id}`);
...
export const getWidgetStats = async (req, res) => {
  try {
    ...
    console.error('❌ GetWidgetStats Error:', error);
    res.status(500).json({
      success: false,
