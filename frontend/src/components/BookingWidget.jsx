...
const BookingWidget = ({ salonId }) => {
  ...
  return (
    <div className="booking-widget w-full max-w-full sm:max-w-md mx-auto bg-white rounded-2xl border border-gray-200 shadow-sm p-4 sm:p-6">
      <div className="mb-4">
        <p className="text-sm uppercase tracking-[0.3em] text-gray-400">Widget</p>
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-gray-900 text-white font-semibold hover:bg-gray-900 transition touch-manipulation"
        >
          Code kopieren
        </button>
      </div>
