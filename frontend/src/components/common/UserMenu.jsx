  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-1 p-1.5 rounded-xl hover:bg-white/5 transition"
      >
        {/* User Avatar */}
        <div className="w-9 h-9 bg-gray-600 border border-gray-500 rounded-full flex items-center justify-center text-white text-sm font-semibold">
          ...
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl border border-gray-100 shadow-lg z-50 overflow-hidden">
            ...
            <div className="py-1">
              <Link
                to="/"
                onClick={() => setShowMenu(false)}
                className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900 transition"
              >
