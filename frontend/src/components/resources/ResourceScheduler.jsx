            ...
            <div
              ...
              className={`bg-white p-6 rounded-xl shadow-sm border-2 transition-all cursor-pointer ${
                selectedResource === resource._id
                  ? 'border-gray-200 ring-2 ring-blue-200'
          ...
          <div className="space-y-3">
            {getResourceBookings(selectedResource).length === 0 ? (
              <div className="py-12 text-center text-gray-400">
                <CalendarIcon className="w-12 h-12 mx-auto mb-4 text-gray-500" />
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        {booking.type === 'maintenance' ? (
                          ...
                          <div className="flex items-center gap-2 px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-xs font-medium">
          ...
          <div className="bg-white rounded-xl shadow-sm max-w-md w-full p-6">
            ...
            <form onSubmit={handleScheduleMaintenance} className="space-y-4">
              ...
              <div className="flex gap-3 mt-6">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-orange-600 text-gray-900 rounded-xl hover:bg-orange-700 transition-colors"
                >
                  Schedule
                </button>
              </div>
