  ...
  if (loading) {
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 animate-pulse">
        <div className="h-6 bg-gray-50 rounded w-1/2 mb-4"></div>
  ...
  return (
    <div className={`border ${borderColor} ${bgColor} rounded-xl p-6`}>
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-lg font-semibold text-gray-900">SMS-Kontingent</h3>
          </div>
        ...
        {/* Enterprise Badge */}
        <span className="px-2 py-1 bg-gray-500/20 text-gray-500 text-xs font-medium rounded">
          ENTERPRISE
        </span>
      </div>
      ...
      <div className="mb-4">
        <div className="flex items-baseline justify-between mb-2">
          <div>
            ...
            <span className="text-gray-500 text-lg ml-1">/ {smsUsage.limit}</span>
          </div>
      ...
      {percentUsed >= 80 && percentUsed < 100 && (
        <div className="mb-4 p-3 bg-yellow-900/30 border border-yellow-800 rounded-xl">
          <div className="flex items-start gap-2">
      ...
      <div className="flex gap-2">
        {smsUsage.used > smsUsage.limit && (
          <Link
            to="/settings/sms"
            className="flex-1 px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white text-sm font-medium rounded-xl transition text-center"
          >
            Extra SMS kaufen
          </Link>
        )}
        <Link
          to="/settings/sms"
          className={`px-4 py-2 bg-gray-50 hover:bg-gray-100 text-gray-900 text-sm font-medium rounded-xl transition text-center ${
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="grid grid-cols-2 gap-4 text-xs text-gray-500">
          <div>
            <span className="block text-gray-400">Team-Größe</span>
            <span className="text-white font-medium">{smsUsage.staffCount} Mitarbeiter</span>
          </div>
          <div>
            <span className="block text-gray-400">Nächster Reset</span>
      ...
      <div className="mt-4 p-3 bg-gray-50/50 rounded-xl">
        <p className="text-xs text-gray-500">
          💡 <strong className="text-gray-900">Tipp:</strong> SMS-Limit skaliert automatisch mit Team-Größe:
