    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
      <div className="p-4 space-y-3">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-gray-500 truncate">{booking.serviceName || booking.serviceId?.name}</p>
          </div>
      ...
      {showActions && (
        <div className="border-t border-gray-100 bg-gray-50 px-3 py-2 space-y-2">
          ...
          {!canMarkNoShow && !canComplete && (
            <p className="text-xs text-gray-500">Keine Schnellaktionen verfügbar.</p>
          )}
        </div>
      )}
    </div>
