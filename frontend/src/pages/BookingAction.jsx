...
const BookingAction = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="w-full mx-auto max-w-lg bg-white rounded-3xl border border-gray-200 shadow-none p-6 space-y-6">
        <div>
          <p className="text-xs uppercase tracking-[0.4em] text-zinc-500 mb-2">Terminaktion</p>
          <h1 className="text-2xl font-bold text-gray-900">{actionLabel}</h1>
          <p className="text-sm text-zinc-400 mt-1">{actionHint}</p>
        </div>

        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 space-y-2">
          <div className="flex justify-between">
            <span className="text-sm text-zinc-400">Salon</span>
          ...
          <div className="flex justify-between">
            <span className="text-sm text-zinc-400">Uhrzeit</span>
            <span className="font-semibold text-gray-800">
        ...
        {loading && (
          <div className="p-4 rounded-2xl bg-white border border-gray-200 text-center text-sm text-zinc-400">
            Lade Buchungsdaten…
          </div>
        )}
        ...
        {!loading && !result && (
          <button
            ...
            className="w-full px-4 py-3 bg-blue-600 text-zinc-900 font-semibold rounded-2xl hover:bg-blue-700 transition touch-manipulation disabled:opacity-60 disabled:cursor-not-allowed"
          >
