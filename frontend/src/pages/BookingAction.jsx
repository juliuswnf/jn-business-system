...
const BookingAction = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <div className="w-full mx-auto max-w-lg bg-white rounded-3xl border border-gray-200 shadow-sm p-6 space-y-6">
        <div>
          <p className="text-xs uppercase tracking-[0.4em] text-gray-500 mb-2">Terminaktion</p>
          <h1 className="text-xl font-semibold tracking-tight text-gray-900">{actionLabel}</h1>
          <p className="text-sm text-gray-400 mt-1">{actionHint}</p>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 space-y-2">
          ...
          <div className="flex justify-between">
            <span className="text-sm text-gray-400">Uhrzeit</span>
            <span className="font-semibold text-gray-800">
        ...
        {loading && (
          <div className="p-4 rounded-2xl bg-white border border-gray-200 text-center text-sm text-gray-400">
            Lade Buchungsdaten…
          </div>
        )}
