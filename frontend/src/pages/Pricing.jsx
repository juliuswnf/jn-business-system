...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Standorte', value: '1', description: 'Für einen Standort' },
      { name: 'Buchungen/Monat', value: '1.000', description: 'Bis zu 1.000 Termine pro Monat - ideal für größere Unternehmen' },
