    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-secondary/50 border border-accent/20 p-4 rounded-lg">
          ...
          <p className="text-3xl font-bold text-green-500">{employees.filter(e => e.status === 'active').length}</p>
        </div>
        <div className="bg-secondary/50 border border-accent/20 p-4 rounded-lg">
            ...
            <div key={employee._id} className="bg-secondary/50 border border-accent/20 rounded-lg p-6 hover:border-accent/40 transition">
              ...
              <div className="space-y-2 mb-4 text-sm">
                <p className="text-slate-350">
                  Role: <span className="text-accent font-semibold capitalize">{employee.role}</span>
                </p>
                <p className="text-slate-350">
                  Status: <span className="text-green-400 font-semibold capitalize">{employee.status}</span>
                </p>
                <p className="text-slate-350">
                  Phone: <span className="text-accent">{employee.phone || 'N/A'}</span>
                </p>
              </div>
