          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-6 text-white">So funktioniert es</h3>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 bg-zinc-900 border border-zinc-800 rounded-xl p-4 hover:border-zinc-700 transition-colors">
              ...
              <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 rounded-xl p-6 text-center">
                <h3 className="text-xl font-bold mb-2 text-white">Bereit loszulegen?</h3>
                <p className="text-sm text-gray-300 mb-5">30 Tage kostenlos testen</p>
                <Link
                  to="/register"
                  className="inline-block w-full px-6 py-3 bg-white text-black font-bold rounded-lg hover:bg-gray-100 transition-colors"
                >
                  Jetzt starten
                </Link>
              </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
                      ...
                      <div key={stepNum} className="flex items-center">
                        <div className="flex flex-col items-center">
                          <div className={`w-10 h-10 rounded-full flex items-center justify-center font-medium transition ${
                            stepNum <= step ? 'bg-white text-black' : 'bg-zinc-800 text-gray-300'
                          }`}>
                            {stepNum + 1}
                          </div>
                          <span className={`text-sm mt-2 ${stepNum <= step ? 'text-white' : 'text-gray-300'}`}>
                            {label}
                          </span>
                        </div>
                        {index < 3 && (
                          <div className={`w-16 md:w-24 h-1 mx-2 md:mx-4 -mt-6 transition ${stepNum < step ? 'bg-white' : 'bg-zinc-800'}`} />
                        )}
                      </div>
                    ))}
                  </div>
                ...
                <div className="p-8">
                          ...
                          >
                            ...
                            <div className="flex justify-between text-sm text-gray-300">
                              <span className="flex items-center gap-2">
                                <FiClock className="text-gray-300" /> {s.duration} Min.
                              </span>
                  ...
                  {step === 1 && !done && (
                    <div>
                      <div className="mb-6">
                        <p className="text-sm text-gray-300 mb-1">Muster Business</p>
                      ...
                      <div className="bg-zinc-800 rounded-lg p-4 mb-6">
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between text-gray-300">
                            ...
                            <span className="text-white">{formatDate(date)}, {time}</span>
                          </div>
                          <div className="flex justify-between pt-2 border-t border-zinc-700 text-white font-semibold">
                      ...
                      <div className="space-y-4 mb-6">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-zinc-500 transition"
                  ...
                  {done && (
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-2xl font-bold mb-2 text-white">Termin bestätigt!</h3>
                      <p className="text-gray-300 mb-2">
                        Bestätigung wurde an <span className="text-white font-medium">{form.email}</span> gesendet.
                      </p>
                      ...
                      <button
                        onClick={reset}
                        className="px-6 py-3 bg-zinc-800 border border-zinc-700 rounded-full text-white hover:bg-zinc-700 transition"
                      >
                        Demo neu starten
                      </button>
                    </div>
