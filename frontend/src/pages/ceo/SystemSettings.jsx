...
export default function SystemSettings() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-gray-900 mb-2">System Settings</h1>
        <p className="text-gray-400">Configure platform integrations and settings</p>
      </div>
      ...
      <div className="bg-secondary/50 border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900 placeholder:text-gray-400"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">SMTP User</label>
                  <input
                    type="text"
          ...
          {activeTab === 'stripe' && (
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Stripe Public Key</label>
                <input
                  type="password"
          ...
          {activeTab === 'sms' && (
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">SMS Provider</label>
                <select
                  value={settings.sms.provider}
                  onChange={(e) => handleChange('sms', 'provider', e.target.value)}
                  className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 text-gray-900"
                >
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Account SID</label>
                <input
                  type="password"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-900 mb-2">Auth Token</label>
                <input
                  type="password"
          ...
          <button
            onClick={handleSave}
            className="mt-8 px-8 py-3 rounded-lg bg-gray-900 hover:bg-gray-800 text-white font-semibold transition duration-300 shadow-sm shadow-gray-100"
          >
            Save Settings
          </button>
        </div>
