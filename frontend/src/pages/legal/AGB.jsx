    ...
    <div className="min-h-screen bg-white text-gray-900 py-16">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          {/* §3 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§3 Kostenlose Testphase</h2>
            <div className="text-gray-600 space-y-3">
              <p>
                (1) Jeder Neukunde erhält eine <strong className="text-gray-900">kostenlose 30-tägige Testphase</strong>
          ...
          <section className="mb-10 bg-green-500/10 border border-green-500/30 rounded-xl p-6">
            ...
            <div className="text-gray-600 space-y-3">
              <p>
                (1) <strong className="text-gray-900">Garantie:</strong> Der Kunde hat das Recht,
                innerhalb von <strong className="text-gray-900">30 Tagen nach der ersten Zahlung</strong>
                ohne Angabe von Gründen vom Vertrag zurückzutreten und eine vollständige
                Rückerstattung zu erhalten.
              </p>
              <p>
                (2) <strong className="text-gray-900">Beantragung:</strong> Die Rückerstattung kann
                per E-Mail an <a href="mailto:support@jn-business-system.de" className="text-gray-300 hover:text-gray-900 hover:underline">
                support@jn-business-system.de</a> beantragt werden.
              </p>
              <p>
                (3) <strong className="text-gray-900">Bearbeitung:</strong> Die Rückerstattung erfolgt
                innerhalb von 14 Werktagen auf das ursprüngliche Zahlungsmittel.
              </p>
              <p>
                (4) <strong className="text-gray-900">Umfang:</strong> Erstattet wird der volle Betrag
          ...
          {/* §5 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§5 Preise und Zahlungsbedingungen</h2>
            <div className="text-gray-600 space-y-3">
              <p>
                (1) Die aktuellen Preise sind auf der Website unter
                <Link to="/pricing" className="text-gray-300 hover:text-gray-900 hover:underline ml-1">/pricing</Link> einsehbar.
              </p>
              <p>
          ...
          {/* §6 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§6 Vertragslaufzeit und Kündigung</h2>
            <div className="text-gray-600 space-y-3">
              <p>
                (1) <strong className="text-gray-900">Monatliche Zahlung:</strong> Der Vertrag verlängert
                sich automatisch um einen weiteren Monat, wenn er nicht vor Ablauf des Abrechnungszeitraums
                gekündigt wird. <strong className="text-gray-900">Keine Mindestlaufzeit.</strong>
              </p>
              <p>
                (2) <strong className="text-gray-900">Jährliche Zahlung:</strong> Der Vertrag verlängert
              ...
              <p>
                ...
                <a href="mailto:support@jn-business-system.de" className="text-gray-300 hover:text-gray-900 hover:underline ml-1">
          ...
          {/* §7 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§7 Datenschutz</h2>
            <div className="text-gray-600 space-y-3">
              <p>
                (1) Der Anbieter verarbeitet personenbezogene Daten gemäß der
                <Link to="/datenschutz" className="text-gray-300 hover:text-gray-900 hover:underline ml-1">Datenschutzerklärung</Link>
          ...
          {/* §8 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§8 Verfügbarkeit</h2>
            <div className="text-gray-600 space-y-3">
              <p>
          ...
          {/* §9 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§9 Haftung</h2>
            <div className="text-gray-600 space-y-3">
              <p>
          ...
          {/* §10 */}
          <section className="mb-10">
            <h2 className="text-xl font-bold text-gray-900 mb-4">§10 Widerrufsrecht</h2>
            <div className="text-gray-600 space-y-3">
              <p>
          ...
          <section className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="text-gray-600">
              <p>
                ...
                <a href="mailto:support@jn-business-system.de" className="text-gray-300 hover:text-gray-900 hover:underline">
