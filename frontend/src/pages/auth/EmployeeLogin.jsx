      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full w-full bg-gray-900 text-white py-3 rounded-xl font-semibold hover:bg-gray-900 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-500">
            ...
            <Link to="/login" className="text-gray-900 hover:text-gray-600 font-medium">
              Zur Login-Auswahl
            </Link>
          </p>
        </div>
