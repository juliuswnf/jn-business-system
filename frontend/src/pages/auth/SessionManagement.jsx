  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 px-4 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        {sessions.length === 0 ? (
          <div className="rounded-xl bg-secondary/50 border border-gray-200 p-8 text-center">
          ...
          <div className="space-y-4">
            {sessions.map((session) => (
              <div
                key={session.id}
                className="rounded-xl bg-secondary/50 border border-gray-200 p-6 hover:border-gray-300 transition"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  {session.isCurrent && (
                    <span className="px-3 py-1 rounded-full bg-gray-100 border border-gray-200 text-gray-700 text-xs font-semibold">
                      Current
                    </span>
                  )}
                </div>
                ...
                {!session.isCurrent && (
                  <button
                    ...
                    className="w-full px-4 py-2 rounded-xl bg-red-500/10 border border-red-500/30 text-red-600 hover:bg-red-500/20 hover:border-red-500/50 font-semibold transition disabled:opacity-50"
                  >
