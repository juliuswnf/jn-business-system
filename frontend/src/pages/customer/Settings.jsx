      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6 py-6 md:py-12">
        ...
        {activeTab === 'profile' && (
          <div className="rounded-xl bg-gray-50 border border-gray-200 p-8">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-semibold tracking-tight">Persönliche Daten</h2>
              <button
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  disabled={!editMode}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl disabled:opacity-50 disabled:cursor-not-allowed focus:border-gray-500 focus:outline-none transition"
                />
              </div>
        ...
        {activeTab === 'bookings' && (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold tracking-tight mb-6">Deine Buchungen</h2>
            {bookingHistory.map(booking => (
              <div key={booking.id} className="rounded-xl bg-gray-50 border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold">{booking.service}</h3>
                    <p className="text-gray-600 text-sm">mit {booking.employee}</p>
                  </div>
                ...
                <div className="grid md:grid-cols-3 gap-4 text-sm">
                  <div>
                    <p className="text-gray-600">Datum & Zeit</p>
        ...
        {activeTab === 'preferences' && (
          <div className="rounded-xl bg-gray-50 border border-gray-200 p-8">
            <h2 className="text-xl font-semibold tracking-tight mb-6">Benachrichtigungseinstellungen</h2>
                ...
                <div key={pref.key} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  ...
                  >
                    <div className={`absolute top-1 w-4 h-4 rounded-full transition transform ${
                      preferences[pref.key] ? 'translate-x-6 bg-white' : 'translate-x-1 bg-gray-900'
                    }`} />
                  </button>
                </div>
              ))}
        ...
        {activeTab === 'security' && (
          <div className="space-y-6">
            {/* Change Password */}
            <div className="rounded-xl bg-gray-50 border border-gray-200 p-8">
              <h2 className="text-xl font-semibold tracking-tight mb-6">Passwort ändern</h2>
            ...
            {/* Account Status */}
            <div className="rounded-xl bg-gray-50 border border-gray-200 p-8">
              <h2 className="text-xl font-semibold tracking-tight mb-6">Kontostatus</h2>
              <div className="space-y-4">
                <div className="p-4 bg-green-50 bg-opacity-20 border border-green-200 rounded-xl">
