...
export default function PhysiotherapyDashboard() {
  return (
    <CoreDashboard
      title="Physiotherapie Kontrollpanel"
      subtitle="Willkommen in deiner Physiotherapie-Praxis."
      ...
      emptySubtitle="Nutze die Zeit für Dokumentation und Therapieplanung."
    />
  );
}
