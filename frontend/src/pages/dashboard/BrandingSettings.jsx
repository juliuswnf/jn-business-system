...
export default function BrandingSettings() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-zinc-900 mb-2">Branding</h1>
        <p className="text-zinc-600">Passen Sie das Aussehen Ihrer Buchungsseite an</p>
      </div>

      {/* Tier Warning */}
      {!permissions.canCustomize && (
        <div className="bg-yellow-50 border border-yellow-600/50 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3">
            <svg className="w-6 h-6 text-yellow-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <div>
              <h3 className="text-yellow-600 font-medium">Custom Branding nicht verfügbar</h3>
              <p className="text-yellow-600/70 text-sm mt-1">
                Custom Branding ist ab dem Professional-Tarif verfügbar.
                <a href="/pricing" className="text-yellow-600 hover:text-yellow-600 ml-1 underline">Jetzt upgraden</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className={`space-y-6 ${!permissions.canCustomize ? 'opacity-50 pointer-events-none' : ''}`}>
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-zinc-900 mb-4">Logo</h2>
          <div className="flex items-center gap-6">
            <div className="w-24 h-24 bg-zinc-50 rounded-lg flex items-center justify-center overflow-hidden">
              {branding.logo ? (
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                disabled={uploading}
                className="bg-zinc-50 hover:bg-zinc-100 text-zinc-900 px-4 py-2 rounded-lg text-sm transition"
              >
              ...
              <p className="text-xs text-zinc-500">JPEG, PNG, SVG oder WebP. Max 5MB.</p>
            </div>
          </div>
        </div>
        ...
        {/* Colors Section */}
        <div className="bg-white border border-zinc-200 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-zinc-900 mb-4">Farben</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="block text-sm text-zinc-600 mb-2">Primärfarbe</label>
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  value={branding.primaryColor}
                  onChange={(e) => setBranding({ ...branding, primaryColor: e.target.value })}
                  className="flex-1 bg-zinc-50 border border-zinc-200 rounded-lg px-3 py-2 text-zinc-900 text-sm"
                />
              </div>
            </div>
            <div>
              <label className="block text-sm text-zinc-600 mb-2">Sekundärfarbe</label>
              <div className="flex items-center gap-3">
                <input
                  type="color"
            ...
            <div>
              <label className="block text-sm text-zinc-600 mb-2">Akzentfarbe</label>
              <div className="flex items-center gap-3">
                <input
                  type="color"
        ...
        {/* Typography & Style */}
        <div className="bg-white border border-zinc-200 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-zinc-900 mb-4">Typografie & Stil</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm text-zinc-600 mb-2">Schriftart</label>
              <select
                value={branding.fontFamily}
                onChange={(e) => setBranding({ ...branding, fontFamily: e.target.value })}
                className="w-full bg-zinc-50 border border-zinc-200 rounded-lg px-4 py-2 text-zinc-900"
              >
                {fonts.map(font => (
            ...
            <div>
              <label className="block text-sm text-zinc-600 mb-2">Button-Stil</label>
              <select
        ...
        <div className="bg-white border border-zinc-200 rounded-xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-lg font-semibold text-zinc-900">White-Label</h2>
        ...
        {/* Preview */}
        <div className="bg-white border border-zinc-200 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-zinc-900 mb-4">Vorschau</h2>
          <div
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              {branding.logo ? (
                ...
                <div className="w-10 h-10 rounded-lg bg-zinc-300"></div>
              )}
              <span className="text-zinc-900 font-semibold">Ihr Unternehmen</span>
            </div>
            <p className="text-zinc-600 mb-4">Wählen Sie einen Service für Ihre Buchung.</p>
            <button
              className={`px-6 py-2 text-zinc-900 font-medium transition ${
            ...
            {branding.showPoweredBy && (
              <p className="text-xs text-zinc-500 mt-4">Powered by JN Business System</p>
            )}
          </div>
        </div>
