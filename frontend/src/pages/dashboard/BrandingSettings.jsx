...
export default function BrandingSettings() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-gray-900 mb-2">Branding</h1>
        <p className="text-gray-600">Passen Sie das Aussehen Ihrer Buchungsseite an</p>
      </div>

      {/* Tier Warning */}
      {!permissions.canCustomize && (
        <div className="bg-yellow-50 border border-yellow-600/50 rounded-xl p-4 mb-6">
      ...
      <div className={`space-y-6 ${!permissions.canCustomize ? 'opacity-50 pointer-events-none' : ''}`}>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                ...
                disabled={uploading}
                className="bg-gray-50 hover:bg-gray-100 text-gray-900 px-4 py-2 rounded-xl text-sm transition"
              >
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="block text-sm text-gray-600 mb-2">Primärfarbe</label>
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  value={branding.primaryColor}
                  onChange={(e) => setBranding({ ...branding, primaryColor: e.target.value })}
                  className="flex-1 bg-gray-50 border border-gray-100 rounded-2xl px-3 py-2 text-gray-900 text-sm"
                />
              </div>
            </div>
            <div>
              <label className="block text-sm text-gray-600 mb-2">Sekundärfarbe</label>
              <div className="flex items-center gap-3">
                <input
                  type="color"
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-2">Akzentfarbe</label>
              <div className="flex items-center gap-3">
                <input
                  type="color"
        ...
        {/* Typography & Style */}
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Typografie & Stil</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm text-gray-600 mb-2">Schriftart</label>
              <select
                value={branding.fontFamily}
                onChange={(e) => setBranding({ ...branding, fontFamily: e.target.value })}
                className="w-full bg-gray-50 border border-gray-100 rounded-2xl px-4 py-2 text-gray-900"
              >
                {fonts.map(font => (
            ...
            <div>
              <label className="block text-sm text-gray-600 mb-2">Button-Stil</label>
              <select
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              {!permissions.canWhiteLabel && (
                <span className="text-xs bg-gray-100/20 text-gray-700 px-2 py-1 rounded">Enterprise</span>
              )}
        ...
        <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-6">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-gray-900 font-semibold">Ihr Unternehmen</span>
            </div>
            <p className="text-gray-600 mb-4">Wählen Sie einen Service für Ihre Buchung.</p>
            <button
              className={`px-6 py-2 text-gray-900 font-medium transition ${
                branding.buttonStyle === 'pill' ? 'rounded-full' :
                branding.buttonStyle === 'square' ? 'rounded-none' : 'rounded-xl'
              }`}
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="bg-red-600 hover:bg-red-700 disabled:bg-gray-600 text-white px-8 py-3 rounded-xl font-medium transition"
          >
