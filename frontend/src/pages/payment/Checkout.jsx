...
const Checkout = ({ onPaymentStart, onPaymentSuccess, onPaymentError }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl shadow-sm p-8">
      <h2 className="text-xl font-semibold tracking-tight mb-6">Checkout</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-700 text-sm mt-1">per month</p>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 focus:border-gray-500 focus:outline-none"
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 placeholder-zinc-400 focus:border-gray-500 focus:outline-none"
          />
        </div>
