          ...
          <div className="max-w-2xl">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl bg-gray-50 text-gray-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-white border border-gray-200"
              />
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-gray-50 rounded-xl shadow-sm p-6 animate-pulse border border-gray-200">
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredSalons.map((salon) => (
                <div
                  key={salon._id}
                  className="bg-gray-50 rounded-xl shadow-sm hover:shadow-md transition-shadow p-6 border border-gray-200"
                >
                  ...
                  <button
                    ...
                    className="w-full bg-white hover:bg-gray-200 text-black font-medium py-2 px-4 rounded-xl transition-colors flex items-center justify-center gap-2"
                  >
                    Jetzt buchen
            ...
            {pagination.pages > 1 && (
              <div className="mt-12 flex justify-center gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-gray-50 border border-gray-100 rounded-2xl text-gray-600 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-100"
                >
                  Zurück
                </button>
